...
"@
    ...
    $lastIndexed   = [int]$fields[0]  # from index_checkpoint
    ...
    # ============================
    if ($remaining -gt 0) {
        # Tune this to your observed speed (your host is doing ~150–300 blocks/sec)
        $blocksPerSec = 200
    ...
    # PROGRESS BAR
    # ============================
    $start = 0  # or set to your known checkpoint start
    $total = $target - $start
    ...
    # OUTPUT
    # ============================
    Write-Host "=== BTC Ingestion Dashboard (Enhanced) ===" -ForegroundColor Cyan
    Write-Host ""
