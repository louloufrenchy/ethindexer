...
<#
 Forensic Suite v2 – BTC Indexer Launcher
#>
...
Write-Host "=== Starting BTC Indexer ===" -ForegroundColor Cyan
...
$LogFile = Join-Path $LogDir "btc_indexer.log"

Write-Host "Logging to: $LogFile" -ForegroundColor DarkGray

$IndexerCommand = @("-m", "forensic_suite_v2.indexers.btc_indexer")
...
Write-Host "BTC indexer started." -ForegroundColor Green
