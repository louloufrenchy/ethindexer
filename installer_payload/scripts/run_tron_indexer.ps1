...
<#
 Forensic Suite v2 – TRON Indexer Launcher
#>
...
Write-Host "=== Starting TRON Indexer ===" -ForegroundColor Cyan
...
$LogFile = Join-Path $LogDir "tron_indexer.log"

Write-Host "Logging to: $LogFile" -ForegroundColor DarkGray

$IndexerCommand = @("-m", "forensic_suite_v2.indexers.tron_indexer")
...
Write-Host "TRON indexer started." -ForegroundColor Green
