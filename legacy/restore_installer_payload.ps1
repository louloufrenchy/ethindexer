param(
    ...
    [string]$PayloadPath      = "F:\DEVELOPMENT\Repo_A\forensic_tracer_installer_project_root\installer_payload",
    [string]$BuildSuitePath   = "F:\DEVELOPMENT\Repo_A\forensic_tracer_installer_project_root\build\ForensicSuite",
    [string]$RepoRootForensic = "F:\DEVELOPMENT\Repo_B\forensic_suite_v2",
    [string]$DistPath         = "F:\DEVELOPMENT\Repo_A\forensic_tracer_installer_project_root\dist",
    [string]$TronDbPath       = "C:\development\tron_indexer\db",
    [string]$TronSqlPath      = "F:\DEVELOPMENT\Repo_B\forensic_suite_v2\forensic_suite_v2\tron_indexer\sql"
)
